...
public class ExecutiveSummary implements Keywords {
	...
	public void sendToLogCustom(logexestatus logexestatus, logaction logaction, String str) {
		logCat.sendToLog(logexestatus, logoperation.ConsiderComment, logtab.ExcSummary, logsubtab.None, logelement.None,
				logaction, null);
	}
}
