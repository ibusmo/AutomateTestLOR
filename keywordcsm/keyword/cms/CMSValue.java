...
public class CMSValue implements KeywordsCSM {
	...
	public boolean execute() {
		...
		try {
			...
			String firstApprTotalField = "firstApprTotalVal";
		...
		try {
			...
			driver.findElement(By.id(contractPriceField)).clear();
		...
		try {
			...
			driver.findElement(By.id(landLndField)).clear();
		...
		try {
			...
			driver.findElement(By.id(appraisalField)).clear();
		...
		try{
			...
			String inputField = "//*[@id='content']/div/form/div/table/tbody/tr[18]/td[2]/input";
		...
		try{
			...
			String inputField = "//*[@id='content']/div/form/div/table/tbody/tr[19]/td[2]/input";
