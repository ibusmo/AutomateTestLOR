...
public class LoanFormLongTermLoan implements KeywordsCSM {
	...
	public void sendToLogCustom(logexestatus logexestatus, logaction logaction) {
		logCat.sendToLog(logexestatus, logoperation.RegScanning, logtab.LoanFormCOM, logsubtab.LongTermLoan, logelement.None,
				logaction, null);
	}
